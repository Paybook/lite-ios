...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidBecomeActive(application: UIApplication) {
        ...
        if currentSession != nil{
            ...
            currentSession.validate({
                response, error in
                if error != nil {
                    print("check session:", error?.message)
                    currentSession = nil
                    isTest = false
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.paybook.LitePaybook" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("LitePaybook", withExtension: "momd")!
